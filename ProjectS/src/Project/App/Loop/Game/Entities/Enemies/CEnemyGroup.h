...
class CEnemyGroup : public CEnemy
{
	public:
		...
		virtual void Init(unsigned int _uiNumElems,float _fSpawnTime,float _fEnergy,const CGVect3& _oPos,const CGString& _sAIScript,const CGString& _sGraphicRes,const CGString& _sPath);

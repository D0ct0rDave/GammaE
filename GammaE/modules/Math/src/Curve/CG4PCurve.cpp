 ...
 */
// ----------------------------------------------------------------------------
const CGVect3& CG4PCurve::oPos(float _fFact) const
{
    float fT = _fFact;
    ...
    /*
        // Implementando operadores en CGVect3
        oQ = 0.5f * ((2.0f*m_oP[1]) +
                     (-m_oP[0] + m_oP[2])*fT +
 ...
 */
// ----------------------------------------------------------------------------
const CGVect3& CG4PCurve::oDir(float _fFact) const
{
    float fT = _fFact;
    float fT2 = _fFact * _fFact;
 ...
 */
// ----------------------------------------------------------------------------
const CGVect3& CG4PCurve::oUp(float _fFact) const
{
    CGVect3 oD;

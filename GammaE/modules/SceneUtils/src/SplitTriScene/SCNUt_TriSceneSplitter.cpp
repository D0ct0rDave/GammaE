...
void SCNUt_TriSceneSplitter::SplitScene (SCNUt_TriScene& _poScene, CPlane& _oPlane, int _iBackTris, int _iFrontTris)
{
...
void SCNUt_TriSceneSplitter::ClassifyAndSplitScene (SCNUt_TriScene& _poScene, CPlane& _oPlane)
{

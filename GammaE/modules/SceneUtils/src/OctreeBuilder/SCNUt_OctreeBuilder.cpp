...
CObject3D * SCNUt_OctreeBuilder::poBuildOctree (SCNUt_TriScene& _oScene, SCNUt_MaterialTable &_oMatTable)
{
      if (! iMaxSubdivisions)
    {
...
CObject3D * SCNUt_OctreeBuilder::poBuildOctreeRec (SCNUt_TriScene& _oScene, int _iCurrentSubs, SCNUt_MaterialTable &_oMatTable)
{
  	// -----------------------------------------------------------

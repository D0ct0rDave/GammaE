...
// -----------------------------------------------------------------------------
    uint castto_uint(TEntityState _eState)
    {
        return( (uint)_eState );
    }
    CSmoother* castto_CSmoother(uobject _uoObj)
    {
        return( (CSmoother*)_uoObj );
    }
    CHUDLabel* castto_CHUDLabel(uobject _uoObj)
    {
        return( (CHUDLabel*)_uoObj );
    }
    CGGameEntity* castto_CGGameEntity(uobject _uoObj)
    {
        return( (CGGameEntity*)_uoObj );
    }
    ...
    class CGUObject
    {
        public:
            ...
            //
            CSmoother* toSmoother()
            {
                return( (CSmoother*)m_uoObj );
            }
            //
            CHUDLabel* toCHUDLabel()
            {
                return( (CHUDLabel*)m_uoObj );
            }
            //
            CGGameEntity* toCGGameEntity()
            {
                return( (CGGameEntity*)m_uoObj );
            }

...
////////////////////////////////////////////////////////////////////////////////
CDXAStar::CDXAStar(CAI_Map* pMap, int forbiddenTiles)
{
...
////////////////////////////////////////////////////////////////////////////////
void CDXAStar::InitAstarTileMap(CAI_Map* pMap, int forbiddenTiles)
{
...
bool CDXAStar::NewPath(int sx,int sy, int dx,int dy)
{
...
bool CDXAStar::ReachedGoal(void) // check it's return value before getting
{                                      // the node entries
...
int CDXAStar::TileNum(int x, int y)
{
...
int CDXAStar::FreeTile(int x, int y)
...
void CDXAStar::BoundaryTiles(void) // This function places 1 around the boundary
...
void CDXAStar::FindPath(int sx, int sy, int dx, int dy)
{
	NODE *Node, *BestNode;
   int TileNumDest;
...
void CDXAStar::GenerateSuccessors(NODE *BestNode, int dx, int dy)
{
   int x, y;
...
void CDXAStar::GenerateSucc(NODE *BestNode,int x, int y, int dx, int dy)
{
   int g, TileNumS, c = 0;
   NODE *Old, *Successor;
...
CDXAStar::NODE
*CDXAStar::CheckOPEN(int tilenum)
{
   NODE *tmp;
...
CDXAStar::NODE
*CDXAStar::CheckCLOSED(int tilenum)
{
   NODE *tmp;
...
void CDXAStar::Insert(NODE *Successor)
{
   NODE *tmp1, *tmp2;
   int f;
...
void CDXAStar::PropagateDown(NODE *Old)
{
   int c, g;
   NODE *Child, *Father;

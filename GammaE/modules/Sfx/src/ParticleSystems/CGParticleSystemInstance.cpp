...
CGParticleSystemInstance::CGParticleSystemInstance(CGParticleSystemGenerator* _poPSG)
{
	...
	{
		m_poMesh->Idxs[i*4+0] = i*4 + 1;
		m_poMesh->Idxs[i*4+1] = i*4 + 0;
		m_poMesh->Idxs[i*4+2] = i*4 + 3;
		m_poMesh->Idxs[i*4+3] = i*4 + 2;

		m_poMesh->UVs[i*4+0].V2(0.0f,0.0f);
		m_poMesh->UVs[i*4+1].V2(0.0f,1.0f);
		m_poMesh->UVs[i*4+2].V2(1.0f,1.0f);
		m_poMesh->UVs[i*4+3].V2(1.0f,0.0f);

		m_poMesh->VXs[i*4+0].V3(0.0f,0.0f,10000.0f);
		m_poMesh->VXs[i*4+1].V3(0.0f,0.0f,10000.0f);
		m_poMesh->VXs[i*4+2].V3(0.0f,0.0f,10000.0f);
		m_poMesh->VXs[i*4+3].V3(0.0f,0.0f,10000.0f);
	}

	// Create leaf object
	m_poLeaf = mNew CObject3D_Leaf();

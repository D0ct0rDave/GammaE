...
void CGPSGGenericQuad::InitParticle(CGPSGGenericQuadParticle* _poPart)
{
    ...
    oIColor.r = MATH_fClamp( 0.0f,1.0f,m_oInitialColor.r * (1.0f + fSRand() * m_fICRandomness) );
    oIColor.g = MATH_fClamp( 0.0f,1.0f,m_oInitialColor.g * (1.0f + fSRand() * m_fICRandomness) );
    oIColor.b = MATH_fClamp( 0.0f,1.0f,m_oInitialColor.b * (1.0f + fSRand() * m_fICRandomness) );
    oIColor.a = MATH_fClamp( 0.0f,1.0f,m_oInitialColor.a * (1.0f + fSRand() * m_fICRandomness) );

    oFColor.r = MATH_fClamp( 0.0f,1.0f,m_oFinalColor.r * (1.0f + fSRand() * m_fFCRandomness) );
    oFColor.g = MATH_fClamp( 0.0f,1.0f,m_oFinalColor.g * (1.0f + fSRand() * m_fFCRandomness) );
    oFColor.b = MATH_fClamp( 0.0f,1.0f,m_oFinalColor.b * (1.0f + fSRand() * m_fFCRandomness) );
    oFColor.a = MATH_fClamp( 0.0f,1.0f,m_oFinalColor.a * (1.0f + fSRand() * m_fFCRandomness) );

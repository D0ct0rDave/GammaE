...
class CGTSViewerGUI : public wxFrame
{
	private:
		DECLARE_EVENT_TABLE();
		
	public:
		CGTSViewerGUI(wxWindow *parent, wxWindowID id = 1, const wxString &title = wxT("GTSViewer"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = CGTSViewerGUI_STYLE);
		virtual ~CGTSViewerGUI();

...
void CLoop::Init()
{
	...
	// Initialize the manager of entities
	CGGameEntityMgr::I()->Init(100);

	// Initialize the manager of renderable entities
	CGGEntityRenderMgr::I()->Init(100);
	...
	// -------------------------------		
	gameGlobals.m_oPerspPrj.ePrjType	= eE3DPrjType_Perspective;
	gameGlobals.m_oPerspPrj.fFOV		= 45.0f;
	gameGlobals.m_oPerspPrj.fNear		= 0.1f;
	gameGlobals.m_oPerspPrj.fFar		= 500.0f;

	gameGlobals.m_oPerspCam.Pos.V3 ( 0, 0,  25);
	gameGlobals.m_oPerspCam.Side.V3( 1, 0,  0);
	...
	gameGlobals.m_oCamera.SetCamera   (&gameGlobals.m_oOrthoCam);
	gameGlobals.m_oCamera.SetProjector(&gameGlobals.m_oOrthoPrj);

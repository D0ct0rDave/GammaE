...
project "Orion"
    ...
    local function isDirExcludedFromList(dir, dirList)
        for _, exclude in ipairs(dirList) do
    ...
    local function isPremakeInDirExcluded(dir)
		return isDirExcludedFromList(dir, excludePremakesInDirs)
    end
	
    local function isDirExcluded(dir)
		return isDirExcludedFromList(dir, excludeDirs)
    end
	...
	local function includeLibraries(rootDir)
        ...
        for _, entry in ipairs(entries) do
			if not isDirExcluded(entry) then	
				print("Entry included: " .. entry)

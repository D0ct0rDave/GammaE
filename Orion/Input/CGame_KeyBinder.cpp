  ...
  //## end CGame_KeyBinder::CGame_KeyBinder%.initialization
{
  //## begin CGame_KeyBinder::CGame_KeyBinder%.body preserve=yes
	...
	CmdBindings.AddVar("Select",(void *)KCMD_SELECT);
	
	CmdBindings.AddVar("SelectBlaster"		,(void *)KCMD_SELW0);
	CmdBindings.AddVar("SelectLaser"		,(void *)KCMD_SELW1);
	CmdBindings.AddVar("SelectHyperBlaster"	,(void *)KCMD_SELW2);
	CmdBindings.AddVar("SelectChaingun"		,(void *)KCMD_SELW3);	
	CmdBindings.AddVar("SelectRailgun"		,(void *)KCMD_SELW4);
	CmdBindings.AddVar("SelectBFG"			,(void *)KCMD_SELW5);
	CmdBindings.AddVar("SelectHomming"		,(void *)KCMD_SELW6);
	CmdBindings.AddVar("SelectNapalm"		,(void *)KCMD_SELW7);
	CmdBindings.AddVar("SelectConcussion"	,(void *)KCMD_SELW8);	
